...
FilterDataFeatures <- function(
  ...
  cat("  * Training (", ncol(filtered_data$training), " features)\n", sep="")
  cat("  * Testing (", ncol(filtered_data$testing), " features)\n", sep="")
  if (!is.null(filtered_data$validation)) {
    cat("  * Validation (", ncol(filtered_data$validation), " features)\n", sep="")
  }
  if (!is.null(filtered_data$external_validation)) {
    cat("  * External validation (", ncol(filtered_data$external_validation), " features)\n", sep="")
  }
